...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="py-8 sm:py-12 lg:py-20 px-4 sm:px-6 lg:px-8 bg-surface/30 relative fade-in-section">
              ...
              <AccordionContent>
                <div className="pt-4">
                  ...
                  <div className="relative">
                    <pre className="bg-bg-primary border border-border rounded-xl p-5 text-[10px] sm:text-xs lg:text-sm font-mono overflow-x-auto whitespace-pre max-w-full">
                      <code>
                  ...
                  <div className="relative">
                    <pre className="bg-bg-primary border border-border rounded-xl p-5 text-[10px] sm:text-xs lg:text-sm font-mono overflow-x-auto whitespace-pre max-w-full">
                      <code>
                        ...
                        {'\n'}
                        <span className="text-text-primary">autoSplit: </span>
                  ...
                  <div className="relative">
                    <pre className="bg-bg-primary border border-border rounded-xl p-5 text-[10px] sm:text-xs lg:text-sm font-mono overflow-x-auto whitespace-pre max-w-full">
                      <code>
                        ...
                        {'\n'}
                        <span className="text-text-primary">yield: </span>
