...
export function ERC8004Section({ locale = 'en' }: { locale?: Locale }) {
  const t = getDict(locale).erc8004;
  return (
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-6 mb-8">
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground text-sm mb-4">
                {t.identityDescBefore}<span className="font-mono text-foreground">45074</span>{t.identityDescAfter}
              </p>
              <TextLink
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground text-sm mb-4">
                {t.feedbackDescBefore}<span className="font-mono text-foreground">giveFeedback()</span>{t.feedbackDescAfter}
              </p>
              <TextLink
          ...
          <CardContent className="pt-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold mb-2">{t.schemaTitle}</h3>
                <p className="text-muted-foreground text-sm mb-4">
                  {t.schemaDesc}
                </p>
