...
2. Prefer `quickStart(..., referrer)` to earn referral rewards (40% of protocol fee to L1 referrer).
...
6. If an agent network exists, route all new agents through a shared referrer to earn multi-level referral rewards.
