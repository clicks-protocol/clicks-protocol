...
export default function GettingStartedPage() {
  return (
    <div className="prose-docs">
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4">
          <div className="glassmorphism rounded-xl p-5">
            <h3 className="font-semibold text-lg mb-2 text-foreground">Node.js</h3>
            <p className="text-muted-foreground text-sm mb-2">Node.js 18+ is required.</p>
            <CodeBlock code="node --version" language="bash" />
          </div>

          <div className="glassmorphism rounded-xl p-5">
            <h3 className="font-semibold text-lg mb-2 text-foreground">Ethers v6</h3>
            <p className="text-muted-foreground text-sm mb-2">The SDK uses ethers v6 for blockchain interactions.</p>
            <CodeBlock code="npm install ethers@^6" language="bash" />
          </div>

          <div className="glassmorphism rounded-xl p-5">
            <h3 className="font-semibold text-lg mb-2 text-foreground">Base RPC</h3>
            <p className="text-muted-foreground text-sm mb-2">Clicks Protocol runs on Base mainnet. Use this RPC endpoint:</p>
      ...
      {/* Install SDK */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Install SDK</h2>
      ...
      {/* Quick Start */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Quick Start (3 Steps)</h2>
        <div className="space-y-6">
          <div className="glassmorphism rounded-xl p-5">
            <h3 className="font-semibold text-lg mb-3 text-foreground">Step 1: Import and Initialize</h3>
...
const clicks = new ClicksClient(signer);`} />
          ...
          <div className="glassmorphism rounded-xl p-5">
            <h3 className="font-semibold text-lg mb-3 text-foreground">Step 2: Quick Start</h3>
            <p className="text-muted-foreground text-sm mb-3">
...
//         200 USDC → earning 7-13% APY on Morpho`} />
          ...
          <div className="glassmorphism rounded-xl p-5">
            <h3 className="font-semibold text-lg mb-3 text-foreground">Step 3: Receive Payments</h3>
            <p className="text-muted-foreground text-sm mb-3">
...
// { activeProtocol: 'Morpho', morphoAPY: 950, aaveAPY: 700 }`} />
      ...
      {/* Withdraw Yield */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Withdraw Yield</h2>
        <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/docs/api" className="glassmorphism rounded-xl p-5 hover-glow cursor-pointer">
            <h3 className="font-semibold text-lg mb-2 text-foreground">SDK Reference</h3>
          ...
          <Link href="/security" className="glassmorphism rounded-xl p-5 hover-glow cursor-pointer">
            <h3 className="font-semibold text-lg mb-2 text-foreground">Security</h3>
            <p className="text-muted-foreground text-sm">
          ...
          >
            <h3 className="font-semibold text-lg mb-2 text-foreground">GitHub</h3>
            <p className="text-muted-foreground text-sm">
          ...
          <a
            ...
            className="glassmorphism rounded-xl p-5 hover-glow cursor-pointer"
          >
            <h3 className="font-semibold text-lg mb-2 text-foreground">Discord</h3>
            <p className="text-muted-foreground text-sm">
