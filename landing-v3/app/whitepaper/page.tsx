    ...
    <div className="prose-docs">
      ...
      <section className="mb-10">
        <div className="glassmorphism rounded-xl p-6">
          ...
          <nav className="space-y-1.5">
            ...
            <div className="pl-4"><a href="#2-2-ai-agent-economy" className="text-muted-foreground hover:text-accent text-sm">2.2 The AI Agent Economy</a></div>
            <div className="pl-4"><a href="#2-3-x402" className="text-muted-foreground hover:text-accent text-sm">2.3 The x402 Payment Protocol</a></div>
            <div className="pl-4"><a href="#2-4-agentic-wallets" className="text-muted-foreground hover:text-accent text-sm">2.4 Coinbase Agentic Wallets</a></div>
            <div><a href="#3-architecture" className="text-accent hover:underline text-sm">3. Protocol Architecture</a></div>
            <div className="pl-4"><a href="#3-1-overview" className="text-muted-foreground hover:text-accent text-sm">3.1 System Overview</a></div>
            <div className="pl-4"><a href="#3-2-registry" className="text-muted-foreground hover:text-accent text-sm">3.2 ClicksRegistry</a></div>
            <div className="pl-4"><a href="#3-3-splitter" className="text-muted-foreground hover:text-accent text-sm">3.3 ClicksSplitterV4</a></div>
            <div className="pl-4"><a href="#3-4-yield-router" className="text-muted-foreground hover:text-accent text-sm">3.4 ClicksYieldRouter</a></div>
            <div className="pl-4"><a href="#3-5-fee" className="text-muted-foreground hover:text-accent text-sm">3.5 ClicksFeeV2</a></div>
            <div className="pl-4"><a href="#3-6-interaction-flow" className="text-muted-foreground hover:text-accent text-sm">3.6 Interaction Flow</a></div>
            <div className="pl-4"><a href="#3-7-contract-addresses" className="text-muted-foreground hover:text-accent text-sm">3.7 Contract Addresses</a></div>
            <div><a href="#4-economic-model" className="text-accent hover:underline text-sm">4. Economic Model</a></div>
            <div className="pl-4"><a href="#4-1-default-split" className="text-muted-foreground hover:text-accent text-sm">4.1 The 80/20 Default Split</a></div>
            <div className="pl-4"><a href="#4-2-protocol-fee" className="text-muted-foreground hover:text-accent text-sm">4.2 Protocol Fee: 2% on Yield</a></div>
            <div className="pl-4"><a href="#4-3-revenue-projections" className="text-muted-foreground hover:text-accent text-sm">4.3 Revenue Projections</a></div>
            <div className="pl-4"><a href="#4-4-black-hole" className="text-muted-foreground hover:text-accent text-sm">4.4 The Black Hole Effect</a></div>
            <div className="pl-4"><a href="#4-5-competitive-comparison" className="text-muted-foreground hover:text-accent text-sm">4.5 Competitive Comparison</a></div>
            <div><a href="#5-security" className="text-accent hover:underline text-sm">5. Security</a></div>
            <div className="pl-4"><a href="#5-1-audit-results" className="text-muted-foreground hover:text-accent text-sm">5.1 Audit Results</a></div>
            <div className="pl-4"><a href="#5-2-adversarial-testing" className="text-muted-foreground hover:text-accent text-sm">5.2 Adversarial Exploit Testing</a></div>
            <div className="pl-4"><a href="#5-3-security-architecture" className="text-muted-foreground hover:text-accent text-sm">5.3 Security Architecture</a></div>
            <div className="pl-4"><a href="#5-4-known-risks" className="text-muted-foreground hover:text-accent text-sm">5.4 Known Risks</a></div>
            <div><a href="#6-sdk" className="text-accent hover:underline text-sm">6. SDK and Integration</a></div>
            <div className="pl-4"><a href="#6-1-typescript-sdk" className="text-muted-foreground hover:text-accent text-sm">6.1 TypeScript SDK</a></div>
            <div className="pl-4"><a href="#6-2-mcp-server" className="text-muted-foreground hover:text-accent text-sm">6.2 MCP Server</a></div>
            <div className="pl-4"><a href="#6-3-agent-discovery" className="text-muted-foreground hover:text-accent text-sm">6.3 Agent Discovery</a></div>
            <div><a href="#7-referral" className="text-accent hover:underline text-sm">7. Referral System (Phase 2)</a></div>
            <div className="pl-4"><a href="#7-1-referral-contract" className="text-muted-foreground hover:text-accent text-sm">7.1 ClicksReferral Contract</a></div>
            <div className="pl-4"><a href="#7-2-multi-level" className="text-muted-foreground hover:text-accent text-sm">7.2 Multi-Level Referral Structure</a></div>
            <div className="pl-4"><a href="#7-3-team-system" className="text-muted-foreground hover:text-accent text-sm">7.3 Team System</a></div>
            <div className="pl-4"><a href="#7-4-yield-bounty" className="text-muted-foreground hover:text-accent text-sm">7.4 Yield Discovery Bounty</a></div>
            <div><a href="#8-regulatory" className="text-accent hover:underline text-sm">8. Regulatory Context</a></div>
            <div className="pl-4"><a href="#8-1-sec-cftc" className="text-muted-foreground hover:text-accent text-sm">8.1 SEC/CFTC Joint Interpretive Release</a></div>
            <div className="pl-4"><a href="#8-2-digital-commodities" className="text-muted-foreground hover:text-accent text-sm">8.2 The 18 Digital Commodities</a></div>
            <div className="pl-4"><a href="#8-3-usdc-stablecoin" className="text-muted-foreground hover:text-accent text-sm">8.3 USDC as Payment Stablecoin</a></div>
            <div className="pl-4"><a href="#8-4-impact-defi" className="text-muted-foreground hover:text-accent text-sm">8.4 Impact on DeFi Yield Protocols</a></div>
      ...
      <section id="1-introduction" className="mb-10">
        ...
        <div id="1-1-the-problem" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">1.1 The Problem: Agent Float Waste</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="1-2-the-solution" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">1.2 The Solution: On-Chain Yield Layer</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="1-3-why-now" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">1.3 Why Now</h3>
          <p className="text-muted-foreground leading-relaxed">
      ...
      <section id="2-background" className="mb-10">
        ...
        <div id="2-1-defi-yield" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">2.1 DeFi Yield on Base</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="2-2-ai-agent-economy" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">2.2 The AI Agent Economy</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="2-3-x402" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">2.3 The x402 Payment Protocol</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="2-4-agentic-wallets" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">2.4 Coinbase Agentic Wallets</h3>
          <p className="text-muted-foreground leading-relaxed">
      ...
      <section id="3-architecture" className="mb-10">
        ...
        <div id="3-1-overview" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">3.1 System Overview</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="3-2-registry" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">3.2 ClicksRegistry</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            <span className="text-foreground font-semibold">Contract Address:</span>{' '}
            <BasescanLink address="0x23bb0Ea69b2BD2e527D5DbA6093155A6E1D0C0a3" />
          </p>
        </div>

        <div id="3-3-splitter" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">3.3 ClicksSplitterV4</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="3-4-yield-router" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">3.4 ClicksYieldRouter</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="3-5-fee" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">3.5 ClicksFeeV2</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="3-6-interaction-flow" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">3.6 Interaction Flow</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="3-7-contract-addresses" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">3.7 Contract Addresses (Base Mainnet)</h3>
          <div className="overflow-x-auto">
            <div className="glassmorphism rounded-xl">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Contract</th>
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Address</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">ClicksRegistry</td>
                    <td className="px-4 py-3"><BasescanLink address="0x23bb0Ea69b2BD2e527D5DbA6093155A6E1D0C0a3" /></td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">ClicksSplitterV4</td>
                    <td className="px-4 py-3"><BasescanLink address="0xB7E0016d543bD443ED2A6f23d5008400255bf3C8" /></td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">ClicksYieldRouter</td>
                    <td className="px-4 py-3"><BasescanLink address="0x053167a233d18E05Bc65a8d5F3F8808782a3EECD" /></td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">ClicksFeeV2</td>
                    <td className="px-4 py-3"><BasescanLink address="0x8C4E07bBF0BDc3949eA133D636601D8ba17e0fb5" /></td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">ClicksReferral</td>
                    <td className="px-4 py-3"><BasescanLink address="0x1E5Ab896D3b3A542C5E91852e221b2D849944ccC" /></td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">Safe Multisig (Owner)</td>
                    <td className="px-4 py-3"><BasescanLink address="0xaD8228fE91Ef7f900406D3689E21BD29d5B1D6A9" /></td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 text-muted-foreground">USDC (Base)</td>
      ...
      <section id="4-economic-model" className="mb-10">
        ...
        <div id="4-1-default-split" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">4.1 The 80/20 Default Split</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="4-2-protocol-fee" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">4.2 Protocol Fee: 2% on Yield</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="4-3-revenue-projections" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">4.3 Revenue Projections</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <div className="overflow-x-auto">
            <div className="glassmorphism rounded-xl">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Total Agent USDC (TVL)</th>
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Capital in Yield (20%)</th>
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Annual Yield Generated</th>
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Protocol Revenue (2%)</th>
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Per-Agent Yield (1000 agents)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">$1M</td>
                    <td className="px-4 py-3 text-muted-foreground">$200K</td>
                    <td className="px-4 py-3 text-muted-foreground">$14,000</td>
                    <td className="px-4 py-3 text-muted-foreground">$280</td>
                    <td className="px-4 py-3 text-muted-foreground">$13.72</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">$10M</td>
                    <td className="px-4 py-3 text-muted-foreground">$2M</td>
                    <td className="px-4 py-3 text-muted-foreground">$140,000</td>
                    <td className="px-4 py-3 text-muted-foreground">$2,800</td>
                    <td className="px-4 py-3 text-muted-foreground">$137.20</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">$100M</td>
                    <td className="px-4 py-3 text-muted-foreground">$20M</td>
                    <td className="px-4 py-3 text-muted-foreground">$1,400,000</td>
                    <td className="px-4 py-3 text-muted-foreground">$28,000</td>
                    <td className="px-4 py-3 text-muted-foreground">$1,372</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 text-muted-foreground">$1B</td>
                    <td className="px-4 py-3 text-muted-foreground">$200M</td>
                    <td className="px-4 py-3 text-muted-foreground">$14,000,000</td>
                    <td className="px-4 py-3 text-muted-foreground">$280,000</td>
                    <td className="px-4 py-3 text-muted-foreground">$13,720</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div id="4-4-black-hole" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">4.4 The Black Hole Effect</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="4-5-competitive-comparison" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">4.5 Competitive Comparison</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      <section id="5-security" className="mb-10">
        ...
        <div id="5-1-audit-results" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">5.1 Audit Results</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <div className="overflow-x-auto mb-4">
            <div className="glassmorphism rounded-xl">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Severity</th>
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Count</th>
                    <th className="text-left px-4 py-3 text-foreground font-semibold">Status</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">Critical</td>
                  ...
                  <tr className="border-b border-white/5">
                    ...
                    <td className="px-4 py-3 text-muted-foreground">Documented</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="px-4 py-3 text-muted-foreground">Low</td>
                    <td className="px-4 py-3 text-muted-foreground">5</td>
                    <td className="px-4 py-3 text-muted-foreground">Acceptable</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 text-muted-foreground">Informational</td>
                    <td className="px-4 py-3 text-muted-foreground">6</td>
                    <td className="px-4 py-3 text-muted-foreground">No action needed</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div id="5-2-adversarial-testing" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">5.2 Adversarial Exploit Testing</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="5-3-security-architecture" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">5.3 Security Architecture</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="5-4-known-risks" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">5.4 Known Risks</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      <section id="6-sdk" className="mb-10">
        ...
        <div id="6-1-typescript-sdk" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">6.1 TypeScript SDK</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
...
// 20 USDC → DeFi yield (Aave V3 or Morpho)`}
        ...
        <div id="6-2-mcp-server" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">6.2 MCP Server</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
            The MCP server (<code className="text-accent bg-accent/10 px-1.5 py-0.5 rounded text-sm">@clicks-protocol/mcp-server</code>) exposes sixteen tools and one resource for AI agents using the Model Context Protocol. MCP is a standard for tool discovery that works with Claude, Cursor, LangChain, and any MCP-compatible client.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-4">
            The sixteen tools split into ten read operations, including agent inspection, split simulation, receipt verification, settlement status, read-only reconciliation, policy replay and receipt trails, plus six write operations for treasury setup, referral attribution, payment routing, withdrawal, registration and split configuration. The <code className="text-accent bg-accent/10 px-1.5 py-0.5 rounded text-sm">clicks://info</code> resource provides protocol metadata.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <div id="6-3-agent-discovery" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">6.3 Agent Discovery</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      <section id="7-referral" className="mb-10">
        ...
        <div id="7-3-team-system" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">7.3 Team System</h3>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <div id="7-4-yield-bounty" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">7.4 Yield Discovery Bounty</h3>
          <p className="text-muted-foreground leading-relaxed">
      ...
      <section id="8-regulatory" className="mb-10">
        ...
        <div id="8-1-sec-cftc" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">8.1 SEC/CFTC Joint Interpretive Release</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div id="8-2-digital-commodities" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">8.2 The 18 Digital Commodities</h3>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <div id="8-3-usdc-stablecoin" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">8.3 USDC as Payment Stablecoin</h3>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <div id="8-4-impact-defi" className="mb-8">
          <h3 className="text-xl font-bold mb-3 text-foreground">8.4 Impact on DeFi Yield Protocols</h3>
          <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      <section id="9-roadmap" className="mb-10">
        ...
        <div className="space-y-6">
          ...
          <div className="glassmorphism rounded-xl p-5">
            ...
            <p className="text-muted-foreground leading-relaxed">
              TypeScript SDK (<code className="text-accent bg-accent/10 px-1.5 py-0.5 rounded text-sm">@clicks-protocol/sdk</code>) with ClicksClient class, treasury setup flow, explicit referral attribution support, Receipt V2 and read-only reconciliation. MCP server (<code className="text-accent bg-accent/10 px-1.5 py-0.5 rounded text-sm">@clicks-protocol/mcp-server</code>) with sixteen tools and one resource. Landing page live at clicksprotocol.xyz with llms.txt and agent.json discovery endpoints. Documentation, README, and demo materials prepared.
            </p>
          </div>
          ...
          <div className="glassmorphism rounded-xl p-5">
            <h3 className="text-lg font-bold mb-2 text-foreground">Phase 4: Multi-Chain Expansion</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="glassmorphism rounded-xl p-5">
            <h3 className="text-lg font-bold mb-2 text-foreground">Phase 5: Governance</h3>
            <p className="text-muted-foreground leading-relaxed">
      ...
      <section id="references" className="mb-10">
        ...
        <ol className="list-decimal list-outside ml-6 space-y-2 text-muted-foreground leading-relaxed text-sm">
      ...
      <section id="appendix-evolution" className="mb-10">
        ...
        <h3 className="text-xl font-bold mb-3 text-foreground">A.1 V2 Contract Upgrade</h3>
        <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <h3 className="text-xl font-bold mb-3 text-foreground">A.2 ERC-8004 Integration</h3>
        <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <h3 className="text-xl font-bold mb-3 text-foreground">A.3 Attestor Schema V1</h3>
        <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <h3 className="text-xl font-bold mb-3 text-foreground">A.4 Positioning: Agent Commerce Settlement Router</h3>
        <p className="text-muted-foreground leading-relaxed mb-4">
