  ...
  return (
    <div className="prose-docs">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-text-primary">Mission</h2>
      ...
      {/* The Problem */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-text-primary">The Problem</h2>
      ...
      {/* The Solution */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-text-primary">The Solution</h2>
        <p className="text-text-secondary leading-relaxed mb-4">
...
// 80 USDC → liquid, 20 USDC → earning 4-8% APY`}
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-text-primary">Built for the x402 Economy</h2>
        <p className="text-text-secondary leading-relaxed mb-4">
      ...
      {/* Security */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-text-primary">Security First</h2>
        <p className="text-text-secondary leading-relaxed mb-4">
      ...
      {/* Team */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-text-primary">Team</h2>
        <p className="text-text-secondary leading-relaxed mb-4">
      ...
      {/* Get Started */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-text-primary">Get Started</h2>
        <p className="text-text-secondary leading-relaxed mb-4">
...
await clicks.quickStart('100', agentAddress);`}
        />
        <h3 className="text-lg font-semibold mt-6 mb-3 text-text-primary">Resources</h3>
        <ul className="space-y-2">
          <li>
            <Link href="/docs/api" className="text-accent hover:underline">
              SDK Reference
            </Link>
            {' '}<span className="text-text-secondary">— Methods, parameters, and code examples</span>
          </li>
          <li>
            <a href="https://github.com/clicks-protocol" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">
              GitHub
            </a>
            {' '}<span className="text-text-secondary">— Source code, issues, contributions</span>
          </li>
          <li>
            <a href="https://discord.gg/clicks-protocol" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">
              Discord
            </a>
            {' '}<span className="text-text-secondary">— Developer community</span>
          </li>
          <li>
            ...
            {' '}<span className="text-text-secondary">— Agent-native tool discovery</span>
          </li>
        </ul>
