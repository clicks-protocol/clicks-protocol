...
export default function SecurityPage() {
  return (
    <div className="prose-docs">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Smart Contract Audits</h2>
        <h3 className="text-lg font-semibold mb-3 text-foreground">Internal Security Review (March 2026)</h3>
        <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div className="glassmorphism rounded-xl p-5 mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">High (mitigated)</div>
            </div>
            <div className="text-center">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Ownership and Governance</h2>
        <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      {/* Battle-Tested */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Battle-Tested</h2>
        <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div className="space-y-4">
          <div className="glassmorphism rounded-lg p-4">
            <h4 className="font-semibold text-sm text-foreground mb-2">Reentrancy Attacks (5 scenarios)</h4>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <div className="glassmorphism rounded-lg p-4">
            <h4 className="font-semibold text-sm text-foreground mb-2">Flash Loan Attacks (5 scenarios)</h4>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <div className="glassmorphism rounded-lg p-4">
            <h4 className="font-semibold text-sm text-foreground mb-2">Access Control Tests (28 checks)</h4>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <div className="glassmorphism rounded-lg p-4">
            <h4 className="font-semibold text-sm text-foreground mb-2">Precision and Rounding Attacks (12 scenarios)</h4>
            <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          <div className="glassmorphism rounded-lg p-4">
            <h4 className="font-semibold text-sm text-foreground mb-2">Griefing and DoS Attacks (11 scenarios)</h4>
            <p className="text-muted-foreground text-sm leading-relaxed">
      ...
      {/* Security Features */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Security Features</h2>
      ...
      {/* ERC-8004 Identity */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">ERC-8004 Identity</h2>
        <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      {/* Contract Addresses */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Contract Addresses (Base Mainnet)</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-left py-3 pr-4 font-semibold text-foreground">Contract</th>
                <th className="text-left py-3 pr-4 font-semibold text-foreground">Address</th>
                <th className="text-left py-3 font-semibold text-foreground">Basescan</th>
              </tr>
            </thead>
            <tbody>
              {contracts.map((c) => (
      ...
      {/* Known Risks */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Known Risks</h2>
        <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={risk.title} className="glassmorphism rounded-lg p-4 border-l-2 border-red-400/50">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">{risk.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Bug Bounty */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Bug Bounty Program</h2>
        <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div className="glassmorphism rounded-xl p-5">
          <p className="text-foreground font-semibold mb-2">Contact</p>
      ...
      {/* Best Practices */}
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4 text-foreground">Best Practices for Users</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={practice.title} className="flex items-start space-x-3">
              ...
              <div>
                ...
                <span className="text-muted-foreground">{practice.desc}</span>
              </div>
            </div>
          ))}
        </div>
