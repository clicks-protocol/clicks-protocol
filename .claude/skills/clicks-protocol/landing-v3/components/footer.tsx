      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="glassmorphism-strong rounded-xl sm:rounded-2xl p-5 sm:p-8 lg:p-10 mb-8 sm:mb-12 lg:mb-14 text-center max-w-2xl mx-auto">
          ...
          >
            <input
              ...
              className="flex-1 bg-surface border border-border rounded-lg px-4 py-3 focus:outline-none focus:border-accent transition-colors w-full"
            />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-10 lg:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-text-secondary">
              <li>
                <a href="/docs" className="hover:text-text-primary transition-colors">
                  Docs Overview
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-text-secondary">
              <li>
                <a href="/llms.txt" className="hover:text-text-primary transition-colors">
                  llms.txt
                </a>
              </li>
              <li>
