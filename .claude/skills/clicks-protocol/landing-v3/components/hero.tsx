      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-8 lg:gap-12 items-center">
          ...
          <div className="parallax" data-speed="0.5">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-text-secondary mb-6 sm:mb-8 lg:mb-12 leading-relaxed max-w-xl">
            ...
            <div className="glassmorphism rounded-xl sm:rounded-2xl p-4 sm:p-6">
              <div className="text-text-secondary text-xs sm:text-sm mb-3 sm:mb-4 tracking-wider uppercase text-center">
                Integrates with
              </div>
          ...
          <div className="parallax" data-speed="0.8">
            <div className="glassmorphism-strong rounded-xl sm:rounded-2xl p-3 sm:p-6 lg:p-8 hover-glow transition-all duration-300">
              ...
              <div className="relative overflow-hidden">
                <pre className="bg-bg-primary border border-border rounded-lg p-3 sm:p-4 lg:p-6 text-[10px] sm:text-xs lg:text-sm overflow-x-auto whitespace-pre max-w-full" style={{ WebkitOverflowScrolling: 'touch' }}>
                  <code>
                    <span className="text-accent">import</span>{' '}
                    <span className="text-text-primary">{'{ ClicksClient }'}</span>{' '}
                    ...
                    <span className="text-text-primary">clicks = </span>
                    <span className="text-accent">new</span>{' '}
                    <span className="text-text-primary">ClicksClient(signer);</span>
                    {'\n'}
                    ...
                    <span className="text-text-primary">, agentAddress);</span>
                    {'\n\n'}
